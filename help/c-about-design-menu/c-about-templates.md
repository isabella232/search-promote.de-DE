...
# Vorlagen{#about-templates}

Sie können Ihre Präsentationsvorlagen und Transportvorlagen **[!UICONTROL Templates]** verwalten.
...
Sie können Änderungen, die Sie an Vorlagen vornehmen, mithilfe der Verlaufsfunktion aus der Dropdownliste des Vorlagennamen in der Tabelle &quot;Vorlagen&quot;wiederherstellen.

Sie können das Seitengewicht einer Präsentationsvorlage verringern, indem Sie das entsprechende **[!UICONTROL Minimize]** Kontrollkästchen der Vorlage in der Vorlagentabelle aktivieren. Durch die Reduzierung der Seitengröße der Vorlage können Sie Inline-JavaScript und -CSS dynamisch minimieren. Sie entfernen auch redundante Leerzeichen im HTML-Code. Die Minimierung des Seitengewichts Ihrer Präsentationsvorlage kann dazu beitragen, Ihre Suchergebnisse schneller zu liefern.

Sie können eine Vorschau der minimierten Vorlage anzeigen, indem Sie auf die Dropdown-Liste neben dem Dateinamen klicken und dann auf **[!UICONTROL Preview minimized]**. Wenn Sie die Vorlage der Hauptpräsentation minimieren, sollten Sie daran denken, die Minimierung für eingeschlossene Vorlagen (mit `guided-include` Tag) zu aktivieren, da diese Option nicht vererbbar ist.
...
## Präsentationsvorlagen {#section_ACDDEA5C499E481C828A517C230D4596}
...
Siehe Tags [für Präsentationsvorlagen](../c-appendices/c-templates.md#reference_F1BBF616BCEC4AD7B2548ECD3CA74C64)
...
Wenn Sie mehrere Präsentationsvorlagen verwenden, stellen Sie sicher, dass Sie die Vorlage angeben, in der die Suchergebnisse zuerst angezeigt werden sollen. Dazu verwenden Sie die **[!UICONTROL Default]** Spalte der Tabelle &quot;Vorlagen&quot;.
...
Standardmäßig ist Ihr Konto für die Verwendung von XML-Transportvorlagen konfiguriert. Wenn Sie Ihre Daten jedoch lieber mit JSON an die geführte Suche weiterleiten möchten, wenden Sie sich an Adobe Consulting, um Ihnen zu helfen.
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Dieser Tag-Satz wird um jedes Suchergebnis herum umschlossen, sodass die geführte Suche erkennt, wo der Inhalt für ein einzelnes Suchergebnis beginnt und endet. </p> <p> <b>Beispiel</b> </p> <p> <code> &nbsp;&nbsp;&nbsp;&nbsp;&lt;results&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;search-results&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;result&gt; 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Jede Facette muss über eigene Facetten-Tags verfügen, bei denen der Parameter name mit dem Facettennamen übereinstimmt. Suchtags werden innerhalb der facet-Tags für die Facettenwerte verwendet. </p> <p>Siehe <a href="../c-about-design-menu/c-about-facets.md#concept_FA912B3B41EE493DB2F492D188457FF5" type="concept" format="dita" scope="local"> Grundlagen </a>. </p> <p> <b>Beispiel</b> </p> <p> <code> &nbsp;&nbsp;&nbsp;&nbsp;&lt;facets&gt; 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&lt;facet&nbsp;name="brand"&gt; 
...
Sie können Präsentationsvorlagen (.tmpl) oder Transportvorlagen (.tpl) **[!UICONTROL Add Template]** zur [!DNL Templates] Seite hinzufügen.
...
1. Klicken Sie auf der [!DNL Templates] Seite auf **[!UICONTROL Add New Template]**.
1. Legen Sie im [!DNL Add Template] Dialogfeld die gewünschten Optionen fest.
   ...
   | Neuer Vorlagentyp | Hier können Sie eine Präsentation oder eine Transportvorlage auswählen, die Sie hinzufügen möchten.  Siehe [Grundlagen zu Vorlagen](../c-about-design-menu/c-about-templates.md). |
...
1. (Optional) Führen Sie auf der [!DNL Templates] Seite einen der folgenden Schritte aus:
...
Sie können den Vorlageneditor verwenden, um den Inhalt Ihrer Präsentations- und Transportvorlagendateien anzuzeigen und zu bearbeiten.
...
Sie können die Vorlagen für gestaffelte Präsentationen und Transporte bearbeiten und testen, während Ihre Website-Besucher weiterhin die Live-Version Ihrer Vorlagen verwenden. Sie testen Ihre gestaffelte Vorlage mit der gestaffelten Version der URL Ihrer Suchdomäne. Sie können beispielsweise Ihre gestaffelte Transportvorlage testen, indem Sie eine gestaffelte Abfrage ( `sp_staged=1`) ausführen, `sp_t` die auf den Namen Ihrer Transportvorlage eingestellt ist. Wenn Sie mit dem Erscheinungsbild des Layouts zufrieden sind, können Sie die Vorlage **[!UICONTROL Push Live]** im Vorlageneditor live schalten. Nachdem die Vorlage live geschaltet wurde, beginnen die Site-Besucher damit, sie zu verwenden.
...
Siehe [Transportvorlage-Tags](../c-appendices/c-templates.md#reference_227D199F5A7248049BE1D405C0584751)

**[!UICONTROL To edit a presentation or a transport template]**

1. Klicken Sie im Produktmenü auf **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. Klicken Sie auf der [!DNL Templates] Seite auf eine Präsentation oder einen Transportvorlagendateinamen.
1. Nehmen Sie auf der [!DNL Template Editor] Seite die gewünschten Änderungen an den Tags und Kodierungen vor.

   Achten Sie auf die Änderungen, die Sie in der [!DNL Template Editor]; Es gibt keine Rückgängig-Funktion. Wenn Sie eine unerwünschte Änderung vornehmen und zur vorherigen Version der Datei zurückkehren möchten, können Sie auf klicken, **[!UICONTROL Cancel]** um zur Tabelle der Vorlagen zurückzukehren (vorausgesetzt, Sie haben bis zu diesem Zeitpunkt keine Änderungen gespeichert). Wenn Sie Ihre Änderungen bereits gespeichert haben, können Sie diese **[!UICONTROL History]** im Editor wiederherstellen.
1. (Optional) Klicken Sie **[!UICONTROL Insert Symbol]** auf , um Sonderzeichen und Symbole einzugeben, die keine entsprechenden Schlüssel auf US-amerikanischen Tastaturen enthalten.
...
Sie können Zeit sparen, indem Sie eine vorhandene Präsentationsvorlage (.tmpl) oder eine Transportvorlage (.tpl) duplizieren und sie der Seite &quot;Vorlagen&quot;hinzufügen. **[!UICONTROL Copy Template]**
...
1. Klicken Sie im Produktmenü auf **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. Klicken Sie auf der [!DNL Templates] Seite in der Dropdownliste neben dem Namen der Vorlage, die Sie kopieren möchten, auf **[!UICONTROL Copy]**.
1. Legen Sie im [!DNL Copy Template] Dialogfeld eine oder mehrere der gewünschten Optionen fest.
...
Sie können den Namen einer vorhandenen Präsentationsvorlage (.tmpl) oder einer Transportvorlage (.tpl) [!DNL Rename Template] ändern.
...
1. Klicken Sie im Produktmenü auf **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. Klicken Sie auf der [!DNL Templates] Seite in der Dropdownliste neben dem Namen der Vorlage, die Sie umbenennen möchten, auf **[!UICONTROL Rename]**.
1. Legen Sie im [!DNL Rename Template] Dialogfeld eine oder mehrere der gewünschten Optionen fest.
...
Sie können eine vorhandene Präsentationsvorlage (.tmpl) oder eine Transportvorlage (.tpl) **[!UICONTROL Delete Template]** entfernen.
...
Möglicherweise haben Sie bereits eine entsprechende Version der gestaffelten Vorlage, die live geschaltet wird. Ist dies der Fall, stellen Sie sicher, dass Sie die gelöschte Vorlage live übertragen, **[!UICONTROL Staging]** damit sie auch aus der Live-Umgebung gelöscht wird. Sie können auch **[!UICONTROL Push Live]** auf der Seite &quot;Vorlagen&quot;verwenden.
...
1. Klicken Sie im Produktmenü auf **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. Klicken Sie auf der [!DNL Templates] Seite in der Dropdownliste neben dem Namen der Vorlage, die Sie löschen möchten, auf **[!UICONTROL Delete]**.
1. Klicken Sie im [!DNL Delete Template] Dialogfeld auf **[!UICONTROL Delete.]**
1. (Optional) Führen Sie einen der folgenden Schritte aus:
...
Sie können **[!UICONTROL Preview minimized]** sehen, wie die reduzierte Seitengröße einer Präsentationsvorlage aussehen würde, wenn Sie sie minimieren möchten.
...
Siehe [Reduzierung der Seitengröße einer Präsentationsvorlage auf Ihrer...](../c-about-design-menu/c-about-templates.md#task_B09BB3CE89714DEAAE8D9A899CF3009E)

Sie müssen bereits eine Vorlage hinzufügen, um die Vorschau der Vorlage minimiert anzuzeigen.

Siehe [Hinzufügen einer neuen Präsentations- oder Transportvorlagendatei](../c-about-design-menu/c-about-templates.md#task_73199757B6E748CAA604902FF913F012)

Sie können eine Vorschau des XML-Codes einer Transportvorlagendatei anzeigen.

Siehe [Anzeigen der XML-Vorschau einer Transportvorlagendatei](../c-about-design-menu/c-about-templates.md#task_58C6C52078E14AD88D2B2F0B3C439AE8)

**So zeigen Sie eine Vorschau der Präsentationsvorlage minimiert an**

1. Klicken Sie im Produktmenü auf **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. Klicken Sie auf der [!DNL Templates] Seite in der Dropdownliste neben dem Namen der Präsentationsvorlage auf **[!UICONTROL Preview minimized]**.

   Verwenden Sie die **[!UICONTROL Type]** Spalte in der Tabelle &quot;Vorlagen&quot;, um die Vorlagen nach Präsentation und Transport zu sortieren.
1. (Optional) Markieren Sie auf der [!DNL Preview Minimized Template] Seite, **[!UICONTROL Wrap lines]** um die Tags im definierten Fenster zu lesen.
...
## Reduzierung des Seitengewichts einer Präsentationsvorlage auf Ihrer Website {#task_B09BB3CE89714DEAAE8D9A899CF3009E}

Mithilfe der **[!UICONTROL Minimize]** Option in der Vorlagentabelle können Sie das Seitengewicht einer Präsentationsvorlage verringern.
...
Durch die Reduzierung der Seitengröße der Vorlage können Sie Inline-JavaScript und -CSS dynamisch minimieren. Sie entfernen auch redundante Leerzeichen im HTML-Code. Die Minimierung des Seitengewichts Ihrer Präsentationsvorlage kann dazu beitragen, Ihre Suchergebnisse schneller zu liefern.

Sie können auch eine Vorschau der minimierten Präsentationsvorlage anzeigen, indem Sie **[!UICONTROL Preview minimized]** diese verwenden.
...
1. Klicken Sie im Produktmenü auf **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. Markieren Sie auf der [!DNL Templates] Seite unter der [!DNL Minimize] Spalte das Kästchen für eine oder mehrere Präsentationsvorlagendateien, die Sie auf Ihrer Website so schnell wie möglich verschieben möchten.

   Verwenden Sie die **[!UICONTROL Type]** Spalte in der [!DNL Templates] Tabelle, um die Vorlagen nach Präsentation und Transport zu sortieren.
1. (Optional) Führen Sie einen der folgenden Schritte aus:
...
## Standardvorlagendatei für die Präsentation auf Ihrer Website festlegen {#task_C1E8CE817E4D43E096167A347C54DD53}
...
1. Klicken Sie im Produktmenü auf **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. Klicken Sie auf der [!DNL Templates] Seite unter der [!DNL Default] Spalte auf das Optionsfeld der entsprechenden Vorlagendatei, die Sie als Standard verwenden möchten.
...
## Vorschau der XML einer Transportvorlagendatei {#task_58C6C52078E14AD88D2B2F0B3C439AE8}

Sie können die XML-Datei einer von Ihnen hinzugefügten Transportvorlage [!DNL Preview] überprüfen.
...
Zur Vorschau der XML-Datei der Vorlage muss bereits eine Transportvorlage hinzugefügt sein.

Siehe [Hinzufügen einer neuen Präsentations- oder Transportvorlagendatei](../c-about-design-menu/c-about-templates.md#task_73199757B6E748CAA604902FF913F012).

Sie können eine Vorschau der reduzierten Vorlagendateien für Präsentationen anzeigen.

Siehe [Anzeigen einer Vorschau der Präsentationsvorlage minimiert](../c-about-design-menu/c-about-templates.md#task_1757B6207CC74221AE4BFFE5674D320B).

**So zeigen Sie die XML-Datei einer Transportvorlagendatei in der Vorschau an**

1. Klicken Sie im Produktmenü auf **[!UICONTROL Design]** > **[!UICONTROL Templates]**.
1. Klicken Sie auf der [!DNL Templates] Seite in der Dropdownliste neben dem Namen der Transportvorlage auf **[!UICONTROL Preview]**.

   Verwenden Sie die **[!UICONTROL Type]** Spalte in der [!DNL Templates] Tabelle, um die Vorlagen nach Präsentation und Transport zu sortieren.
1. Schließen Sie das Ansichtsfenster und kehren Sie zurück zu [!DNL site search/merchandising].
1. (Optional) Führen Sie einen der folgenden Schritte aus:
