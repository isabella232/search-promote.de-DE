...
# Über das Menü Berichte{#about-the-reports-menu}

Verwenden Sie das Menü &quot;Berichte&quot;, um Berichte zu den Abfragen der Kundensuche Ansicht oder zurückzusetzen.

+ [Ansichten](/help/c-about-reports-menu/c-about-data-views.md)
+ [Warnhinweise](/help/c-about-reports-menu/c-about-alerts.md)

## Ansicht des Berichts &quot;Begriffe&quot;oder des Berichts &quot;Null-Suchbegriffe&quot; {#task_53B7ED1582DD4B0E8376546A7AFC789A}
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Visuelle Darstellung der relativen Anzahl der Suchen nach einem bestimmten Wort oder einer bestimmten Wortgruppe. </p> <p>Verwenden Sie dies, um schnell festzustellen, welche Abfragen für Ihre Kunden am wichtigsten sind. </p> </td> 
  </tr> 
  <tr> 
...
1. (Optional) Klicken Sie in der Tabelle unter der Spalte [!DNL Words] auf ein Wort, um die Seite [!DNL Live Simulator for Today] zu öffnen.

   Siehe [Info zum Simulator](../c-about-simulator.md#concept_020AA6751E32421A96A3455508364C7E), wo Sie Suchbegriffe Ansicht und testen können.
1. (Optional) Klicken Sie auf **[!UICONTROL Reset Terms Report]**, um alle Berichtinformationen zu den Begriffen für das derzeit angemeldete Konto zu löschen.
...
Die Seiten [!DNL Staged Adobe Analytics Terms Report] und [!DNL Staged Adobe Analytics Report Suites] zeigen die folgenden Informationen in einer Tabelle an:
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Identifiziert den Namen der Adobe Analytics Report Suite. </p> <p>Siehe <a href="../c-about-settings-menu/c-about-adobe-analytics-menu.md#task_6DE17305EA7146DA8C30FF8FDF68A3C0" type="task" format="dita" scope="local"> Hinzufügen einer Adobe Analytics Report Suite</a>. </p> <p>Siehe <a href="../c-about-settings-menu/c-about-adobe-analytics-menu.md#task_360904CCBBB140238ADA036C3CC07664" type="task" format="dita" scope="local"> Bearbeiten der Adobe Analytics-Metriken einer Report Suite</a>. </p> </td> 
  </tr> 
  <tr> 
...
## Ansicht des Suchanforderungsberichts oder des Inhaltsanforderungsberichts {#task_4C6EFB4D51474FC1BDE4326D1A726ECC}

Sie können die Ansicht [!DNL Search Requests Report] verwenden, um die Anzahl der Suchanforderungen über einen bestimmten Zeitraum anzuzeigen. Sie können auch die Ansicht [!DNL Content Requests Report] verwenden, um die Anzahl der Inhaltsanforderungen über einen bestimmten Zeitraum anzuzeigen.
...
1. Wählen Sie auf der Berichtsseite in der Dropdown-Liste **[!UICONTROL Period]** die Zeitdauer aus, die in den Bericht aufgenommen werden soll.
1. Wählen Sie in der Dropdown-Liste **[!UICONTROL Chart Type]** je nach Bericht eine der folgenden Optionen aus:
...
1. Wählen Sie in der Dropdown-Liste **[!UICONTROL Chart Style]** aus, wie die Daten im Bericht dargestellt werden sollen.

## Ansicht des Berichts zur Suchindexgröße {#task_90CF717A53D341F49E8DE17505321950}
...
## Ansicht des Crawl Performance Report oder des Staged Crawl Performance Report {#task_60ED9FD9769C48B1B5EEE7099B1D1899}
...
1. Führen Sie im Produktmenü einen der folgenden Schritte aus:
   ...
   + Klicken **[!UICONTROL Reports]** > **[!UICONTROL Crawl Performance]**.

      Wählen Sie auf der Berichtsseite in der Dropdown-Liste **[!UICONTROL Crawl Ending]** die Zeitdauer aus, die in den Bericht aufgenommen werden soll.

   + Klicken **[!UICONTROL Reports]** > **[!UICONTROL Staged Crawl Performance]**.

      Wählen Sie auf der Berichtsseite in der Dropdown-Liste **[!UICONTROL Staged Crawl Ending]** die Zeitdauer aus, die in den Bericht aufgenommen werden soll.

1. Wählen Sie in der Dropdown-Liste **[!UICONTROL Metric]** eine der folgenden Metriken aus:
...
1. Wählen Sie in der Dropdown-Liste **[!UICONTROL Chart Style]** aus, wie die Daten im Bericht dargestellt werden sollen. Sie können **[!UICONTROL Bars]** oder **[!UICONTROL Area]** auswählen.
1. Wählen Sie in der Dropdown-Liste **[!UICONTROL Chart Type]** die Indexstufe aus, auf der Sie einen Bericht erstellen möchten. Sie können **[!UICONTROL Full]**, **[!UICONTROL Incremental]** oder **[!UICONTROL Full & Incremental]** auswählen.
...
1. Verwenden Sie auf der Seite [!DNL Change Log] die Navigations- und Anzeigeoptionen oben und unten auf der Seite, um die Protokollinformationen Ansicht.
