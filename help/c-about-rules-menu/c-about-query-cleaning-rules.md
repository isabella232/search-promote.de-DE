---
description: Verwenden Sie die Regeln zur Abfrage-Bereinigung, um die eingehende Abfrage zu analysieren und zu ändern.
seo-description: Verwenden Sie die Regeln zur Abfrage-Bereinigung, um die eingehende Abfrage zu analysieren und zu ändern.
seo-title: Info zu Regeln für die Abfrage-Bereinigung
solution: Target
title: Info zu Regeln für die Abfrage-Bereinigung
...
# Info zu Regeln für die Abfrage-Bereinigung{#about-query-cleaning-rules}

Verwenden Sie die Regeln zur Abfrage-Bereinigung, um die eingehende Abfrage zu analysieren und zu ändern.

## Verwenden von Regeln für die Abfragebereinigung {#concept_17F3CDDC3C8A4128AF092A82B777B86C}
...
## Info zu Abfragebereinigungsbedingungen {#section_BF6F25F94FED4DDEA8600D921EA43A66}
...
## Informationen zu Aktionen zur Abfrage-Bereinigung {#section_78F74A9B48DE484191CDA95F5B4E7154}
...
Siehe Tabelle der Optionen unter [Hinzufügen einer Abfragebereinigungsregel](../c-about-rules-menu/c-about-query-cleaning-rules.md#task_47F43988D3D9485F8AE1DFDA7E00BF54).

## Info zu Umleitungen {#section_597481E6194440C0A7B9E6FC901A81C0}
...
## Hinzufügen einer Abfragebereinigungsregel {#task_47F43988D3D9485F8AE1DFDA7E00BF54}
...
1. Klicken Sie auf der [!DNL Query Cleaning Rules] Seite auf **[!UICONTROL Add New Rule]**.
1. Geben Sie in das [!DNL Name] Feld den Namen der neuen Abfragebereinigungsregel ein.
1. Verwenden Sie auf der [!DNL Add Query Cleaning Rule] Seite die Dropdownlisten und Textfelder, um Ihre Abfrage zu erstellen.
   ...
   <table> 
    ...
    <tbody> 
      ...
      <td colname="col2"> <p>CGI-Parameter, die an die Abfrage übergeben werden. </p> </td> 
      </tr> 
      <tr> 
...
## Bearbeiten einer Abfragebereinigungsregel {#task_FA2FF1A7E2634350AD703485CBC27CB3}
...
1. Klicken Sie im Produktmenü auf **[!UICONTROL Rules]** > **[!UICONTROL Query Cleaning]**.
1. Klicken Sie auf der [!DNL Query Cleaning Rules] Seite unter der **[!UICONTROL Actions]** Spalte der Tabelle auf **[!UICONTROL Edit]** die zugehörige Regel, die Sie bearbeiten möchten.
1. Verwenden Sie auf der [!DNL Edit Query Cleaning Rule] Seite die Dropdownlisten und Textfelder, um Ihre Abfrage zu erstellen.
...
## Löschen einer Abfragebereinigungsregel {#task_C52D17226B824590B087CAB6970CBB01}
...
1. Klicken Sie im Produktmenü auf **[!UICONTROL Rules]** > **[!UICONTROL Query Cleaning]**.
1. Klicken Sie auf der [!DNL Query Cleaning Rules] Seite unter der **[!UICONTROL Actions]** Spalte der Tabelle auf **[!UICONTROL Delete]** die entsprechende Regel, die Sie löschen möchten.
...
## Ändern der Reihenfolge, in der die Abfragebereinigungsregeln ausgeführt werden {#task_C24012C45A4445468A7FD998017388CA}
...
Die Regeln zur Abfragebereinigung werden in der Reihenfolge ausgeführt, in der sie definiert wurden. Je höher die Ordnungsnummer einer Regel ist, desto später wird sie im Prozess ausgeführt, wodurch frühere Regeln übertroffen werden. Sie können Regeln neu anordnen, indem Sie eine neue Zahl in die Spalte Reihenfolge der Tabelle auf der [!DNL Query Cleaning Rules] Seite eingeben. Sie können die Ausführungsreihenfolge auch per Drag &amp; Drop ändern.

**So ändern Sie die Reihenfolge, in der die Abfragebereinigungsregeln ausgeführt werden**

1. Klicken Sie im Produktmenü auf **[!UICONTROL Rules]** > **[!UICONTROL Query Cleaning]**.
1. Führen Sie auf der [!DNL Query Cleaning Rules] Seite einen der folgenden Schritte aus:

   * Klicken Sie auf die [!DNL Order] Spaltenüberschrift, um die Regeln in auf- oder absteigender Reihenfolge zu sortieren.
   * Geben Sie in der [!DNL Order] Spalte im Textfeld links neben dem Namen der Abfragebereinigungsregel die laufende Nummer ein, die die Regel ausführen soll.
