---
description: Verwenden Sie das Menü "Mein Profil", um persönliche Informationen, Voreinstellungen, Anmeldekennwort und Zugriffsberechtigungen anzuzeigen.
seo-description: Verwenden Sie das Menü "Mein Profil", um persönliche Informationen, Voreinstellungen, Anmeldekennwort und Zugriffsberechtigungen anzuzeigen.
seo-title: Über das Menü "Mein Profil"
solution: Target
subtopic: My Profile
title: Über das Menü "Mein Profil"
...
Verwenden Sie das Menü &quot;Mein Profil&quot;, um persönliche Informationen, Voreinstellungen, Anmeldekennwort und Zugriffsberechtigungen anzuzeigen.

## Konfigurieren Ihrer persönlichen Benutzerinformationen {#task_A11A3BE2527B4204B896E04303B04AA6}

Sie können Ihre mit Ihrem Konto verknüpften persönlichen Benutzerdaten anzeigen und verwalten, einschließlich der Festlegung Ihrer erforderlichen E-Mail-Adresse und der Zeichenkodierung, die von den meisten Seiten Ihrer Website verwendet wird.
...
Wenn Sie die E-Mail-Adresse angeben, muss sie nur ASCII-Zeichen enthalten. Standardalphabetisch (a...z) Zeichen oder numerische `(0..9)` Zeichen mit genau einem `@` Zeichen, mit dem der Benutzername von der Domäne getrennt wird. Die Zeichen `_`, `+`, `-`, `.`, `!`, `#`, `$`,,,, `'`,,, `%``&``*``=``?``^``{``}` , und sind ebenfalls zulässig. Ihre E-Mail-Adresse darf nicht mit einem Punkt (`.`) beginnen.

Siehe [Konfigurieren Ihrer Voreinstellungen](../c-about-settings-menu/c-about-my-profile-menu.md#task_5E06BF565C284C2EBBE18E10A1C4BFBB).
...
1. Geben Sie auf der [!DNL Personal Information] Seite die gewünschten Felder an.

   Es ist nur das [!DNL Email Address] Feld erforderlich.
...
1. Legen Sie auf der [!DNL My Preferences] Seite die gewünschten Felder fest.
...
Wenn Sie Ihr Passwort vergessen oder verlieren, klicken Sie auf **[!UICONTROL Forgot your password?]** die Anmeldeseite und befolgen Sie die Anweisungen, um ein neues Passwort zu generieren.
...
1. Geben Sie auf der [!DNL Change Password] Seite im [!DNL Current Password] Feld das aktuelle Anmeldekennwort ein, das Sie verwenden.
1. Geben Sie in das [!DNL New Password] Feld und das [!DNL New Password (again)] Feld das neue Anmeldekennwort ein, das Sie verwenden möchten.
1. Klicken Sie auf **Änderungen speichern**.

## Abbrechen der Anmeldung {#task_D57701BB726243B08CEA14EEC86C3087}

Sie können Ihre Adobe-Anmeldung stornieren. Wenn Sie Ihre Anmeldung stornieren, können Sie mit der angezeigten E-Mail-Adresse nicht auf dieses Konto oder ein anderes Adobe-Konto zugreifen.
...
1. Klicken Sie auf der [!DNL Cancel Login] Seite auf **[!UICONTROL Cancel Login]**.
1. Klicken Sie auf **[!UICONTROL Yes]** , um die Stornierung zu bestätigen.

## Ansicht Ihrer Zugriffsberechtigungen {#task_6107C5BA333B4053A56325AE5E3A1848}
...
Die Baumansicht zeigt die Seiten im Mitgliedercenter an, die eingeschränkt werden können, und ob Sie derzeit Zugriff auf diese Seite haben, wie durch ein Häkchen gekennzeichnet.
...
Das Privileg **[!UICONTROL Can push live]** in der Baumansicht ist ein spezielles Steuerelement, das jedem Benutzer in dieser Rolle die Möglichkeit gibt, gestapelte Elemente live zu übertragen. Wenn Sie eine Rolle erstellen, die nicht über diese Funktion verfügt, können Sie sicherstellen, dass Benutzer in dieser Rolle Ihre Live-Suche erst dann beeinflussen können, wenn jemand mit der Möglichkeit, die Einstellungen live zu übertragen, ihre Arbeit überprüft und dies tut.
...
So können Sie beispielsweise einige Benutzer in einer Rolle verwenden, die zwar Stage-Indizes, aber keine Live-Indizes ausführen können, oder die Stage-Einstellung live übertragen können. Benutzer mit dieser Rolle können ihre gesamte Arbeit in einer gestaffelten Umgebung testen, ohne den Live-Index zu beeinträchtigen. Bei einigen Einstellungen müssen Sie den Index neu erstellen, bevor Sie eine Vorschau der vorgenommenen Änderungen anzeigen können.
...
**So zeigen Sie Ihre Zugriffsberechtigungen an**

1. Klicken Sie im Produktmenü auf **[!UICONTROL Settings]** > **[!UICONTROL My Profile]** > **[!UICONTROL My Access Privileges]**.
1. Erweitern Sie auf der [!DNL My Access Privileges] Seite die Baumansichten, um die Berechtigungen oder den eingeschränkten Zugriff zu überprüfen.
